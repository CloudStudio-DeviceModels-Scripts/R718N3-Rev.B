...
function getEndpoints(deviceAddress, endpoints)
{
    ...
    endpoints.addEndpoint("1", "Current sensor", endpointType.currentSensor);

    endpoints.addEndpoint("2", "Current sensor", endpointType.currentSensor);

    endpoints.addEndpoint("3", "Current sensor", endpointType.currentSensor);
