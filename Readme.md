...
# Configuration Script – R718N3 - Rev. B

This **Configuration** script is designed for the **R718N3** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – R718N3 Rev. B

Este script de **Configuration** está diseñado para el modelo **R718N3** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
